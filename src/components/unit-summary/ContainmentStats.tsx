...
const AreaIcon = () => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <Path d="M21 1.5H7.5V3H21V1.5Z" fill="#AEAEB2"/>
    <Path d="M22.5 7.5V21H21V7.5H22.5Z" fill="#AEAEB2"/>
    <Path d="M3 22.5H16.5V21H3V22.5Z" fill="#AEAEB2"/>
    <Path d="M1.5 3V16.5H3V3H1.5Z" fill="#AEAEB2"/>
  </Svg>
);
...
export function ContainmentStats() {
  const { colors } = useTheme();
  return (
    <View style={styles.container}>
      <StyledText weight="600" style={[styles.title, { color: colors.outageTitle }]}>Containment</StyledText>
      <View style={styles.cardsRow}>
        <StatCard icon={<AreaIcon />} label={'Operation\nArea'} value="0.1" unit="mSv/h" />
        <StatCard icon={<TempIcon />} label={'Average\nTemperature'} value="28.5" unit="°c" />
        <StatCard icon={<PressureIcon />} label="Pressure" value="17.3" unit="cmH₂O" />
      </View>
    </View>
  );
}
